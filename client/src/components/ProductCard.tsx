...
import { Package, ExternalLink, Tag, Layers, ArrowRight } from "lucide-react";
...
export function ProductCard({ productCode, name, category, material, status, onViewDetails }: ProductCardProps) {
  return (
